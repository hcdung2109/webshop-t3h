        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" method="post" action="{{ route('admin.product.update', ['product' => $model->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input {{ $model->stock }} id="stock" name="stock" type="number" class="form-control" placeholder="">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Gía bán</label>
                                <input value="{{ $model->price }}" id="price" name="price" type="text" class="form-control" placeholder="">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Gía khuyến mại</label>
                                <input value="{{ $model->sale }}" id="sale" name="sale" type="text" class="form-control" placeholder="">
                            </div>
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-primary btnCreate">Lưu lại</button>
                        </div>
                    </form>
                </div>
                <!-- /.box -->
